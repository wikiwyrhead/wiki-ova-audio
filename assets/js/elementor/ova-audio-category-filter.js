(function($) {
    "use strict";
        ...
        $(window).on('elementor/frontend/init', function () {
            ...
            /* Audio Category Ajax */
            function playAudioAjax () {
                $('.item-audio-list').each( function() {
                    var that = $(this);
                    ova_audio_play(that);
                });
            }
        
            elementorFrontend.hooks.addAction('frontend/element_ready/ovau_elementor_audio_category_filter.default', function(){
               
                $('.ova-audio-category-filter .audio-categories').each( function() {
                    var that         = $(this);
                    ...
                    if ( audio_active && typeof audio_active != "undefined" ) {
                        loadAjaxCategoryFilter(audio, audio_active, 1);
                    }
                    ...
                    category.on('click', function(e) {
                        ...
                        loadAjaxCategoryFilter(audio, slug, 1);
                ...
                function loadAjaxCategoryFilter( that = null, slug = '', paged = 1 ) {
                        ...
                        $.ajax({
                            ...
                            success: function(response){
                                ...
                                that.find('.page-numbers').on('click', function(e) {
                                    ...
                                    if ( current != page ) {
                                        loadAjaxCategoryFilter( that, slug, page );
                                        $('html, body').animate({
