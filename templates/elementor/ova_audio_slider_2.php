<?php
	...
	$data_filter = isset( $args['data_filter'] ) ? $args['data_filter'] : 'by_category';
	...
	if( $data_filter == 'any_audio' ) {
		$audios   = ovau_get_data_audio_manual( $args );
	}

?>

<div class="ova-audio-slider-2">
	<div class="content slide-audio-2 owl-carousel owl-theme" data-options="<?php echo esc_attr(json_encode($data_options)) ?>">
