...
<div class="ova-audio-main-slider">

	<div class="content main-slide-audio owl-carousel owl-theme" data-options="<?php echo esc_attr(json_encode($data_options)) ?>">

		<?php if( $audios->have_posts() ) : while ( $audios->have_posts() ) : $audios->the_post(); ?>

			<?php ovau_get_template( 'parts/audio-item-main-slider.php', $args ); ?>
